...
public class JwtTokenIssuer {
  ...
  public static JwtTokenIssuer fromPrivateKey(final byte[] privateKey)
    ...
    if (isPEM.matches()) {
      ...
      spec = new PKCS8EncodedKeySpec(pkcs8Key);
    } else {
   ...
   * manually.
   *
   * <p>Adapted from {@link https://github.com/Mastercard/client-encryption-java/blob/master/src
   * /main/java/com/mastercard/developer/utils/EncryptionUtils.java}
   */
